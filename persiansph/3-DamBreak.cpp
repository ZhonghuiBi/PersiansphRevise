...
int main(int argc, char **argv) try
{
	...
	dom.Dimension = 2;
	//No of threads which are going to use in parallel calculation
	dom.Nproc = 4;
	//Integration scheme: 0 = Modified Verlet, 1 = Leapfrog
	dom.Scheme = 0;
	//
	...
	Cs	= 10.0 * sqrt(g*H);
	t   = (0.2*h/Cs);
	//Initial distance of particles for Inflow BC
	dom.InitialDist = dx;
